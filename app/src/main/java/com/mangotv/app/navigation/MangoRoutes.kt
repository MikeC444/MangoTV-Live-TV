...
object MangoRoutes {
    ...
    const val LIVE_TV_PLAYER_PATTERN = "live_tv/player/{channelId}"
    ...
    fun liveTvPlayer(channelId: String): String =
        "live_tv/player/${URLEncoder.encode(channelId, "UTF-8")}"
