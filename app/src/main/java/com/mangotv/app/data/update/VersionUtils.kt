...
internal data class SemanticVersion(
    ...
    private fun comparePrereleaseIdentifier(left: String, right: String): Int {
        ...
        // Numeric identifiers always sort lower than alphanumeric ones (semver rule).
...
/** Parses/compares version strings like "0.1.23-alpha" or "v1.2.3" (a leading "v" is ignored). */
